        ...
        case "formMaterial":
                ...
                if (dupflag != 1){
                    MaterialDataTable.row.add([
                        ...
                        material_name,
                        '<input type="number" class="qty_out form-control form-control-sm border border-success" name="qty_out[]" value="0" min="1"  max="'+qty_balance+'" step="1" style="text-align:right;"/>',
                        ...
                        '<a  href="#" class="btn btn-outline-danger btn-sm tempbtndelete"><span class="fas fa-trash fa-fw"></span></a>',
                    ]).draw(false)
                }
        break;
        case "formAsset":
